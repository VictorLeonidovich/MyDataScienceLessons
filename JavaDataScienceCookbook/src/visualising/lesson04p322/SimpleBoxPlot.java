package visualising.lesson04p322;
...
public class SimpleBoxPlot extends ExamplePanel {
	...
	public SimpleBoxPlot() {
		...
		plot.getAxisRenderer(BoxPlot.AXIS_X).setCustomTicks(
				DataUtils.map(new Double[] { 1.0, 2.0, 3.0 }, new String[] { "Column 1", "Column 2", "Column 3" }));
		//
		...
		//
		BoxWhiskerRenderer pointRenderer = (BoxWhiskerRenderer) plot.getPointRenderer(boxData);
		//
